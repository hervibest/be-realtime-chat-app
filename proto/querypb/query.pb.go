...
type GetTenLatestMessageRequest struct {
...
func (x *GetTenLatestMessageRequest) Reset() {
	*x = GetTenLatestMessageRequest{}
...
func (x *GetTenLatestMessageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTenLatestMessageRequest) ProtoMessage() {}

func (x *GetTenLatestMessageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_query_proto_msgTypes[0]
...
// Deprecated: Use GetTenLatestMessageRequest.ProtoReflect.Descriptor instead.
func (*GetTenLatestMessageRequest) Descriptor() ([]byte, []int) {
	return file_query_proto_rawDescGZIP(), []int{0}
}

func (x *GetTenLatestMessageRequest) GetRoomId() string {
	if x != nil {
		return x.RoomId
	}
	return ""
...
type GetTenLatestMessageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetTenLatestMessageResponse) Reset() {
	*x = GetTenLatestMessageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetTenLatestMessageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTenLatestMessageResponse) ProtoMessage() {}

func (x *GetTenLatestMessageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_query_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTenLatestMessageResponse.ProtoReflect.Descriptor instead.
func (*GetTenLatestMessageResponse) Descriptor() ([]byte, []int) {
	return file_query_proto_rawDescGZIP(), []int{1}
}

func (x *GetTenLatestMessageResponse) GetStatus() int64 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *GetTenLatestMessageResponse) GetError() string {
	if x != nil {
		return x.Error
	}
	return ""
...
func (x *GetTenLatestMessageResponse) GetMessage() []*Message {
	if x != nil {
		return x.Message
	}
	return nil
...
var file_query_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x35, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x54, 0x65, 0x6e, 0x4c, 0x61,
	0x74, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x12, 0x17, 0x0a, 0x07, 0x72, 0x6f, 0x6f, 0x6d, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x6f, 0x6f, 0x6d, 0x49, 0x64, 0x22, 0x75, 0x0a, 0x1b, 0x47,
	0x65, 0x74, 0x54, 0x65, 0x6e, 0x4c, 0x61, 0x74, 0x65, 0x73, 0x74, 0x4d, 0x65, 0x73, 0x73, 0x61,
	...
	0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x28, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x22, 0xa0, 0x01, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x0e,
	...
	,
...
var file_query_proto_goTypes = []interface{}{
	(*GetTenLatestMessageRequest)(nil),  // 0: proto.GetTenLatestMessageRequest
	(*GetTenLatestMessageResponse)(nil), // 1: proto.GetTenLatestMessageResponse
	(*Message)(nil),                     // 2: proto.Message
}
var file_query_proto_depIdxs = []int32{
	2, // 0: proto.GetTenLatestMessageResponse.message:type_name -> proto.Message
	0, // 1: proto.QueryService.GetTenLatestMessage:input_type -> proto.GetTenLatestMessageRequest
	1, // 2: proto.QueryService.GetTenLatestMessage:output_type -> proto.GetTenLatestMessageResponse
...
func file_query_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTenLatestMessageRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTenLatestMessageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
